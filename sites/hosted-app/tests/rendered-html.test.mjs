...
test("server-renders the Guanxiang product", async () => {
  ...
  assert.match(html, /hero-entry-wide-v3\.png/);
  assert.match(html, /hero-entry-square-v3\.png/);
  assert.match(html, /hero-entry-mobile-v3\.png/);
  assert.match(html, /entry-hero-final/);
  assert.doesNotMatch(html, /hero-taiji-ripple-v1\.png/);
  assert.match(html, /hero-ripple-ring-v1\.png/);
  assert.match(html, /hero-ink-drop-v2\.png/);
  assert.match(html, /hero-taiji-breath-v2\.png/);
  assert.match(html, /hero-birds-v1\.png/);
  assert.match(html, /hero-boat-v1\.png/);
  assert.match(html, /hero-waterfall-v1\.png/);

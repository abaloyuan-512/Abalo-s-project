...
import ProductPresentationView, { type ProductPresentation } from "../app/direct-reading-v2-preview/ProductPresentation";
...
test("product view keeps P8 and P9 responsibilities separate", () => {
